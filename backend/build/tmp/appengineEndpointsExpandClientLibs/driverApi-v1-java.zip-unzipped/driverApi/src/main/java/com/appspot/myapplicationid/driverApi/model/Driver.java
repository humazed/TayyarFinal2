...
package com.appspot.myapplicationid.driverApi.model;

/**
 * Model definition for Driver.
 *
 * <p> This is the Java data model class that specifies how to parse/serialize into the JSON that is
 * transmitted over HTTP when working with the driverApi. For a detailed explanation see:
...
public final class Driver extends com.google.api.client.json.GenericJson {
   ...
   */
  public Driver setDeviceMac(java.lang.String deviceMac) {
   ...
   */
  public Driver setId(java.lang.Long id) {
    this.id = id;
    return this;
  }
   ...
   */
  public Driver setWifiMac(java.lang.String wifiMac) {
