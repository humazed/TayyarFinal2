...
package com.appspot.tayyar_trial.customerApi;
...
public class CustomerApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.23.0 of the customerApi library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class CreateCustomer extends CustomerApiRequest<com.appspot.tayyar_trial.customerApi.model.Customer> {
    ...
    protected CreateCustomer(java.lang.String name, java.lang.String email, java.lang.String mainAddress, java.lang.String phone) {
      super(CustomerApi.this, "POST", REST_PATH, null, com.appspot.tayyar_trial.customerApi.model.Customer.class);
  ...
  public class CreateDeliveryRequest extends CustomerApiRequest<com.appspot.tayyar_trial.customerApi.model.DeliveryRequest> {
    ...
    protected CreateDeliveryRequest(java.lang.Long customerID) {
      super(CustomerApi.this, "POST", REST_PATH, null, com.appspot.tayyar_trial.customerApi.model.DeliveryRequest.class);
  ...
  public class GetDeliveryRequestsOfCustomer extends CustomerApiRequest<com.appspot.tayyar_trial.customerApi.model.DeliveryRequestCollection> {
    ...
    protected GetDeliveryRequestsOfCustomer(java.lang.Long customerID) {
      super(CustomerApi.this, "GET", REST_PATH, null, com.appspot.tayyar_trial.customerApi.model.DeliveryRequestCollection.class);
      this.customerID = com.google.api.client.util.Preconditions.checkNotNull(customerID, "Required parameter customerID must be specified.");
    }
  ...
  /**
   * Create a request for the method "getFeedOfTopMerchants".
   *
   * This request holds the parameters needed by the customerApi server.  After setting any optional
   * parameters, call the {@link GetFeedOfTopMerchants#execute()} method to invoke the remote
   * operation.
   *
   * @param cursorStr
   * @param orderByOption
   ...
   * @return the request
   */
  public GetFeedOfTopMerchants getFeedOfTopMerchants(java.lang.String cursorStr, java.lang.String orderByOption, java.lang.Integer limitNumber) throws java.io.IOException {
    GetFeedOfTopMerchants result = new GetFeedOfTopMerchants(cursorStr, orderByOption, limitNumber);
    initialize(result);
    return result;
  }

  public class GetFeedOfTopMerchants extends CustomerApiRequest<com.appspot.tayyar_trial.customerApi.model.CollectionResponseMerchantView> {

    private static final String REST_PATH = "collectionresponse_merchantview/{cursorStr}/{orderByOption}/{limitNumber}";

    /**
     * Create a request for the method "getFeedOfTopMerchants".
     *
     * This request holds the parameters needed by the the customerApi server.  After setting any
     * optional parameters, call the {@link GetFeedOfTopMerchants#execute()} method to invoke the
     * remote operation. <p> {@link GetFeedOfTopMerchants#initialize(com.google.api.client.googleapis.
     * services.AbstractGoogleClientRequest)} must be called to initialize this instance immediately
     * after invoking the constructor. </p>
     *
     * @param cursorStr
     ...
     * @since 1.13
     */
    protected GetFeedOfTopMerchants(java.lang.String cursorStr, java.lang.String orderByOption, java.lang.Integer limitNumber) {
      super(CustomerApi.this, "GET", REST_PATH, null, com.appspot.tayyar_trial.customerApi.model.CollectionResponseMerchantView.class);
      this.cursorStr = com.google.api.client.util.Preconditions.checkNotNull(cursorStr, "Required parameter cursorStr must be specified.");
    ...
    @Override
    public GetFeedOfTopMerchants setAlt(java.lang.String alt) {
      return (GetFeedOfTopMerchants) super.setAlt(alt);
    }

    @Override
    public GetFeedOfTopMerchants setFields(java.lang.String fields) {
      return (GetFeedOfTopMerchants) super.setFields(fields);
    }

    @Override
    public GetFeedOfTopMerchants setKey(java.lang.String key) {
      return (GetFeedOfTopMerchants) super.setKey(key);
    }

    @Override
    public GetFeedOfTopMerchants setOauthToken(java.lang.String oauthToken) {
      return (GetFeedOfTopMerchants) super.setOauthToken(oauthToken);
    }

    @Override
    public GetFeedOfTopMerchants setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetFeedOfTopMerchants) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetFeedOfTopMerchants setQuotaUser(java.lang.String quotaUser) {
      return (GetFeedOfTopMerchants) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetFeedOfTopMerchants setUserIp(java.lang.String userIp) {
      return (GetFeedOfTopMerchants) super.setUserIp(userIp);
    }
    ...
    public GetFeedOfTopMerchants setCursorStr(java.lang.String cursorStr) {
    ...
    public GetFeedOfTopMerchants setOrderByOption(java.lang.String orderByOption) {
    ...
    public GetFeedOfTopMerchants setLimitNumber(java.lang.Integer limitNumber) {
      this.limitNumber = limitNumber;
      return this;
    }

    @Override
    public GetFeedOfTopMerchants set(String parameterName, Object value) {
      return (GetFeedOfTopMerchants) super.set(parameterName, value);
    }
  }

  /**
   * Create a request for the method "getInventory".
   *
   * This request holds the parameters needed by the customerApi server.  After setting any optional
   * parameters, call the {@link GetInventory#execute()} method to invoke the remote operation.
   *
   * @return the request
   */
  public GetInventory getInventory() throws java.io.IOException {
    GetInventory result = new GetInventory();
    initialize(result);
    return result;
  }

  public class GetInventory extends CustomerApiRequest<com.appspot.tayyar_trial.customerApi.model.Inventory> {

    private static final String REST_PATH = "inventory";

    /**
     * Create a request for the method "getInventory".
     *
     * This request holds the parameters needed by the the customerApi server.  After setting any
     * optional parameters, call the {@link GetInventory#execute()} method to invoke the remote
     * operation. <p> {@link
     * GetInventory#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @since 1.13
     */
    protected GetInventory() {
      super(CustomerApi.this, "GET", REST_PATH, null, com.appspot.tayyar_trial.customerApi.model.Inventory.class);
    }
    ...
    @Override
    public GetInventory setAlt(java.lang.String alt) {
      return (GetInventory) super.setAlt(alt);
    }

    @Override
    public GetInventory setFields(java.lang.String fields) {
      return (GetInventory) super.setFields(fields);
    }

    @Override
    public GetInventory setKey(java.lang.String key) {
      return (GetInventory) super.setKey(key);
    }

    @Override
    public GetInventory setOauthToken(java.lang.String oauthToken) {
      return (GetInventory) super.setOauthToken(oauthToken);
    }

    @Override
    public GetInventory setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetInventory) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetInventory setQuotaUser(java.lang.String quotaUser) {
      return (GetInventory) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetInventory setUserIp(java.lang.String userIp) {
      return (GetInventory) super.setUserIp(userIp);
    }

    @Override
    public GetInventory set(String parameterName, Object value) {
      return (GetInventory) super.set(parameterName, value);
    }
  }
  ...
  public class GetItemsOfCategoryByID extends CustomerApiRequest<com.appspot.tayyar_trial.customerApi.model.ItemCollection> {
    ...
    protected GetItemsOfCategoryByID(java.lang.Long categoryID) {
      super(CustomerApi.this, "GET", REST_PATH, null, com.appspot.tayyar_trial.customerApi.model.ItemCollection.class);
  ...
  /**
   * Create a request for the method "getListOfItemsByCategoryNameOrderedBy".
   *
   * This request holds the parameters needed by the customerApi server.  After setting any optional
   * parameters, call the {@link GetListOfItemsByCategoryNameOrderedBy#execute()} method to invoke the
   * remote operation.
   *
   * @param categoryName
   * @param cursorStr
   ...
   * @return the request
   */
  public GetListOfItemsByCategoryNameOrderedBy getListOfItemsByCategoryNameOrderedBy(java.lang.String categoryName, java.lang.String cursorStr, java.lang.Integer limitNumber, java.lang.String orderByOption) throws java.io.IOException {
    GetListOfItemsByCategoryNameOrderedBy result = new GetListOfItemsByCategoryNameOrderedBy(categoryName, cursorStr, limitNumber, orderByOption);
    initialize(result);
    return result;
  }

  public class GetListOfItemsByCategoryNameOrderedBy extends CustomerApiRequest<com.appspot.tayyar_trial.customerApi.model.CollectionResponseItem> {

    private static final String REST_PATH = "getListOfItemsByCategoryNameOrderedBy";

    /**
     * Create a request for the method "getListOfItemsByCategoryNameOrderedBy".
     *
     * This request holds the parameters needed by the the customerApi server.  After setting any
     * optional parameters, call the {@link GetListOfItemsByCategoryNameOrderedBy#execute()} method to
     * invoke the remote operation. <p> {@link GetListOfItemsByCategoryNameOrderedBy#initialize(com.go
     ...
     * @since 1.13
     */
    protected GetListOfItemsByCategoryNameOrderedBy(java.lang.String categoryName, java.lang.String cursorStr, java.lang.Integer limitNumber, java.lang.String orderByOption) {
      super(CustomerApi.this, "GET", REST_PATH, null, com.appspot.tayyar_trial.customerApi.model.CollectionResponseItem.class);
    ...
    @Override
    public GetListOfItemsByCategoryNameOrderedBy setAlt(java.lang.String alt) {
      return (GetListOfItemsByCategoryNameOrderedBy) super.setAlt(alt);
    }

    @Override
    public GetListOfItemsByCategoryNameOrderedBy setFields(java.lang.String fields) {
      return (GetListOfItemsByCategoryNameOrderedBy) super.setFields(fields);
    }

    @Override
    public GetListOfItemsByCategoryNameOrderedBy setKey(java.lang.String key) {
      return (GetListOfItemsByCategoryNameOrderedBy) super.setKey(key);
    }

    @Override
    public GetListOfItemsByCategoryNameOrderedBy setOauthToken(java.lang.String oauthToken) {
      return (GetListOfItemsByCategoryNameOrderedBy) super.setOauthToken(oauthToken);
    }

    @Override
    public GetListOfItemsByCategoryNameOrderedBy setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetListOfItemsByCategoryNameOrderedBy) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetListOfItemsByCategoryNameOrderedBy setQuotaUser(java.lang.String quotaUser) {
      return (GetListOfItemsByCategoryNameOrderedBy) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetListOfItemsByCategoryNameOrderedBy setUserIp(java.lang.String userIp) {
      return (GetListOfItemsByCategoryNameOrderedBy) super.setUserIp(userIp);
    }
    ...
    public GetListOfItemsByCategoryNameOrderedBy setCategoryName(java.lang.String categoryName) {
    ...
    public GetListOfItemsByCategoryNameOrderedBy setCursorStr(java.lang.String cursorStr) {
      this.cursorStr = cursorStr;
      return this;
    }
    ...
    public GetListOfItemsByCategoryNameOrderedBy setLimitNumber(java.lang.Integer limitNumber) {
      this.limitNumber = limitNumber;
      return this;
    }
    ...
    public GetListOfItemsByCategoryNameOrderedBy setOrderByOption(java.lang.String orderByOption) {
      this.orderByOption = orderByOption;
      return this;
    }

    @Override
    public GetListOfItemsByCategoryNameOrderedBy set(String parameterName, Object value) {
      return (GetListOfItemsByCategoryNameOrderedBy) super.set(parameterName, value);
    }
  }

  /**
   * Create a request for the method "getListOfMerchantsByCategoryNameOrderedBy".
   *
   * This request holds the parameters needed by the customerApi server.  After setting any optional
   * parameters, call the {@link GetListOfMerchantsByCategoryNameOrderedBy#execute()} method to invoke
   ...
   * @return the request
   */
  public GetListOfMerchantsByCategoryNameOrderedBy getListOfMerchantsByCategoryNameOrderedBy(java.lang.String categoryName, java.lang.String cursorStr, java.lang.Integer limitNumber, java.lang.String orderByOption) throws java.io.IOException {
    GetListOfMerchantsByCategoryNameOrderedBy result = new GetListOfMerchantsByCategoryNameOrderedBy(categoryName, cursorStr, limitNumber, orderByOption);
    initialize(result);
    return result;
  }

  public class GetListOfMerchantsByCategoryNameOrderedBy extends CustomerApiRequest<com.appspot.tayyar_trial.customerApi.model.CollectionResponseMerchantView> {

    private static final String REST_PATH = "getListOfMerchantsByCategoryNameOrderedBy";

    /**
     * Create a request for the method "getListOfMerchantsByCategoryNameOrderedBy".
     *
     * This request holds the parameters needed by the the customerApi server.  After setting any
     * optional parameters, call the {@link GetListOfMerchantsByCategoryNameOrderedBy#execute()}
     * method to invoke the remote operation. <p> {@link GetListOfMerchantsByCategoryNameOrderedBy#ini
     ...
     * @since 1.13
     */
    protected GetListOfMerchantsByCategoryNameOrderedBy(java.lang.String categoryName, java.lang.String cursorStr, java.lang.Integer limitNumber, java.lang.String orderByOption) {
      super(CustomerApi.this, "GET", REST_PATH, null, com.appspot.tayyar_trial.customerApi.model.CollectionResponseMerchantView.class);
      this.categoryName = com.google.api.client.util.Preconditions.checkNotNull(categoryName, "Required parameter categoryName must be specified.");
      this.cursorStr = com.google.api.client.util.Preconditions.checkNotNull(cursorStr, "Required parameter cursorStr must be specified.");
      this.limitNumber = com.google.api.client.util.Preconditions.checkNotNull(limitNumber, "Required parameter limitNumber must be specified.");
    ...
    @Override
    public GetListOfMerchantsByCategoryNameOrderedBy setAlt(java.lang.String alt) {
      return (GetListOfMerchantsByCategoryNameOrderedBy) super.setAlt(alt);
    }

    @Override
    public GetListOfMerchantsByCategoryNameOrderedBy setFields(java.lang.String fields) {
      return (GetListOfMerchantsByCategoryNameOrderedBy) super.setFields(fields);
    }

    @Override
    public GetListOfMerchantsByCategoryNameOrderedBy setKey(java.lang.String key) {
      return (GetListOfMerchantsByCategoryNameOrderedBy) super.setKey(key);
    }

    @Override
    public GetListOfMerchantsByCategoryNameOrderedBy setOauthToken(java.lang.String oauthToken) {
      return (GetListOfMerchantsByCategoryNameOrderedBy) super.setOauthToken(oauthToken);
    }

    @Override
    public GetListOfMerchantsByCategoryNameOrderedBy setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetListOfMerchantsByCategoryNameOrderedBy) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetListOfMerchantsByCategoryNameOrderedBy setQuotaUser(java.lang.String quotaUser) {
      return (GetListOfMerchantsByCategoryNameOrderedBy) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetListOfMerchantsByCategoryNameOrderedBy setUserIp(java.lang.String userIp) {
      return (GetListOfMerchantsByCategoryNameOrderedBy) super.setUserIp(userIp);
    }
    ...
    public GetListOfMerchantsByCategoryNameOrderedBy setCategoryName(java.lang.String categoryName) {
      this.categoryName = categoryName;
      return this;
    }
    ...
    public GetListOfMerchantsByCategoryNameOrderedBy setCursorStr(java.lang.String cursorStr) {
      this.cursorStr = cursorStr;
      return this;
    }
    ...
    public GetListOfMerchantsByCategoryNameOrderedBy setLimitNumber(java.lang.Integer limitNumber) {
      this.limitNumber = limitNumber;
      return this;
    }
    ...
    public GetListOfMerchantsByCategoryNameOrderedBy setOrderByOption(java.lang.String orderByOption) {
      this.orderByOption = orderByOption;
      return this;
    }

    @Override
    public GetListOfMerchantsByCategoryNameOrderedBy set(String parameterName, Object value) {
      return (GetListOfMerchantsByCategoryNameOrderedBy) super.set(parameterName, value);
    }
  }
   ...
   * @return the request
   */
  public GetListOfMerchantsViewsOrderedBy getListOfMerchantsViewsOrderedBy(java.lang.String cursorStr, java.lang.String orderByOption, java.lang.String merchantType, java.lang.Integer limitNumber) throws java.io.IOException {
    GetListOfMerchantsViewsOrderedBy result = new GetListOfMerchantsViewsOrderedBy(cursorStr, orderByOption, merchantType, limitNumber);
    initialize(result);
    return result;
  }

  public class GetListOfMerchantsViewsOrderedBy extends CustomerApiRequest<com.appspot.tayyar_trial.customerApi.model.CollectionResponseMerchantView> {

    private static final String REST_PATH = "collectionresponse_merchantview/{cursorStr}/{orderByOption}/{merchantType}/{limitNumber}";
     ...
     * @since 1.13
     */
    protected GetListOfMerchantsViewsOrderedBy(java.lang.String cursorStr, java.lang.String orderByOption, java.lang.String merchantType, java.lang.Integer limitNumber) {
      super(CustomerApi.this, "GET", REST_PATH, null, com.appspot.tayyar_trial.customerApi.model.CollectionResponseMerchantView.class);
      this.cursorStr = com.google.api.client.util.Preconditions.checkNotNull(cursorStr, "Required parameter cursorStr must be specified.");
      this.orderByOption = com.google.api.client.util.Preconditions.checkNotNull(orderByOption, "Required parameter orderByOption must be specified.");
  ...
  public class GetMerchantByID extends CustomerApiRequest<com.appspot.tayyar_trial.customerApi.model.Merchant> {
    ...
    protected GetMerchantByID(java.lang.Long merchantID) {
      super(CustomerApi.this, "GET", REST_PATH, null, com.appspot.tayyar_trial.customerApi.model.Merchant.class);
  ...
  public class GetMerchantByName extends CustomerApiRequest<com.appspot.tayyar_trial.customerApi.model.MerchantViewCollection> {
    ...
    protected GetMerchantByName(java.lang.String name) {
      super(CustomerApi.this, "GET", REST_PATH, null, com.appspot.tayyar_trial.customerApi.model.MerchantViewCollection.class);
      this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
    }
  ...
  public class GetMerchantMenuByID extends CustomerApiRequest<com.appspot.tayyar_trial.customerApi.model.MenuView> {
    ...
    protected GetMerchantMenuByID(java.lang.Long merchantID) {
      super(CustomerApi.this, "GET", REST_PATH, null, com.appspot.tayyar_trial.customerApi.model.MenuView.class);
      this.merchantID = com.google.api.client.util.Preconditions.checkNotNull(merchantID, "Required parameter merchantID must be specified.");
    }
  ...
  public class GetMerchantViewByID extends CustomerApiRequest<com.appspot.tayyar_trial.customerApi.model.MerchantView> {
    ...
    protected GetMerchantViewByID(java.lang.Long merchantID) {
      super(CustomerApi.this, "GET", REST_PATH, null, com.appspot.tayyar_trial.customerApi.model.MerchantView.class);
      this.merchantID = com.google.api.client.util.Preconditions.checkNotNull(merchantID, "Required parameter merchantID must be specified.");
    }
  ...
  public class SendDeliveryRequest extends CustomerApiRequest<com.appspot.tayyar_trial.customerApi.model.DeliveryRequest> {
